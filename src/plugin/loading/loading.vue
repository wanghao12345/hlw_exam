    ...
    <div class="loading-box" v-show="show">
        <div class="loading-content">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32" style="enable-background:new 0 0 50 50;" xml:space="preserve">
              ...
              <circle transform="rotate(45 16 16)" cx="16" cy="3" r="0.428504">
              ...
              <circle transform="rotate(180 16 16)" cx="16" cy="3" r="0.0153358">
              ...
              <circle transform="rotate(225 16 16)" cx="16" cy="3" r="0.659048">
              ...
              <circle transform="rotate(270 16 16)" cx="16" cy="3" r="1.99599">
              ...
              <circle transform="rotate(315 16 16)" cx="16" cy="3" r="2.83463">
